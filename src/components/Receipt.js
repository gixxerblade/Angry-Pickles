...
const Receipt = () => {
  ...
  <GetDate>{date}</GetDate>
    ...
    <p>{data.shipping.address.line1}<br/>{data.shipping.address.city}, {data.shipping.address.state}<br/> {data.shipping.address.postal_code}</p>
    <ReceiptTable/>
    <InvoiceBox style={{marginTop:"1rem",textAlign:"center"}}>If you have any questions, contact us at <a href="mailto:sales@angrypickles.com">sales@angrypickles.com</a> or call at <a href="tel:19105453000">+1 910-545-3000</a>.	</InvoiceBox>
</InvoiceBox>} </>;
};
...
width: 100%;
height: 35%;
background-image: linear-gradient(90deg, rgba(116,186,42,1) 0%, rgba(189,210,166,1) 45%, rgba(116,186,42,1) 100%);
